...
public class tariffIndivid extends TestNgTestBase {

  @Test
  public void testTariffIndivid() throws Exception {
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (isElementPresent(By.xpath("//div[@id='contents']//li[5][@data-item='tariff']"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }

    driver.findElement(By.xpath("//div[@id='contents']//li[5][@data-item='tariff']")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
